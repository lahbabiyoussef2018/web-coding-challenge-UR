...
if(isset($_POST["brand"])){
	$nshop_query = "SELECT * FROM nearbyshops";
	$run_query = mysqli_query($con,$nshop_query);
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>Nearby Shops</h4></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$nshopid = $row["id_shop"];
			$shop_name = $row["name_shop"];
			echo "
					<li><a href='#' class='selectBrand' bid='$nshopid'>$shop_name</a></li>
			";
		}
		echo "</div>";
	}
...
if(isset($_POST["getProduct"])){
	...
	$product_query = "SELECT * FROM products ORDER BY distance DESC LIMIT $start,$limit";
				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>$.$pro_price.00
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-success btn-xs'>Like</button>
									
									 
									
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>Dislike</button>
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["selectSNearbyShop"])|| isset($_POST["search"])){
	if(isset($_POST["get_seleted_Category"])){
		...
		}else if(isset($_POST["selectSNearbyShop"])){
		$id = $_POST["id_shop"];
		$sql = "SELECT * FROM nearbyshops WHERE id_shop = '$id'";
	}else {
